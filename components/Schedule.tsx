...
const schedule = [
  ...
  { time: "23:30", event: "Cake Cutting", icon: Gift },
...
export default function Schedule() {
  return (
    <Card className="p-6 sm:p-8">
      <h2 className="text-2xl sm:text-3xl font-serif text-center mb-6 sm:mb-8">Schedule</h2>
      <div className="max-w-md mx-auto">
        {schedule.map((item, index) => (
          <div key={index} className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="w-14 sm:w-16 text-right font-semibold">{item.time}</div>
